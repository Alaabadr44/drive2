...
:: Generated on 2026-01-10 11:21:45.180020 from credentials file
...
start "" "%chrome_path%" ^
 ...
 "https://192.168.1.182/login?email=DAILYDOSE@RSWaterway.com&password=u94x3n07&autologin=true"
exit /b 0
