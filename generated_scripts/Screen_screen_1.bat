@echo off
:: Auto-generated login script for Screen 1 (Screen)
:: Generated on 2026-01-10 11:21:45.179091 from credentials file
...
start "" "%chrome_path%" ^
 ...
 "https://192.168.1.182/login?email=line1@waterway.com&password=12345678&autologin=true"
exit /b 0
