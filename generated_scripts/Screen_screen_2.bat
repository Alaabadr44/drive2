@echo off
:: Auto-generated login script for Screen 2 (Screen)
:: Generated on 2026-01-10 11:21:45.179350 from credentials file
...
start "" "%chrome_path%" ^
 ...
 "https://192.168.1.182/login?email=line2@waterway.com&password=12345678&autologin=true"
exit /b 0
