...
:: Generated on 2026-01-10 11:21:45.181113 from credentials file
...
start "" "%chrome_path%" ^
 ...
 "https://192.168.1.182/login?email=NUDEBAKERY@RSWaterway.com&password=qh55mpqm&autologin=true"
exit /b 0
